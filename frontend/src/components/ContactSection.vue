<template>
    <section class="text-white mt-20" id="contact">
        ...
        <div class="grid md:grid-cols-2 gap-4 relative px-4 xl:px-16 mt-8" data-aos="zoom-in-up">
            <div>
                <p class="text-[#adb7be]">I would love to hear from you! Whether you have a question or want to collaborate, feel free to reach out using any of the contact methods below. I am always ready to connect and discuss new opportunities or ideas.
                ...
                <div class="col-lg-4 col-md-4 mb-lg-0 mt-5">
                    <div class="flex mb-10 items-center">
                      ...
                      <div class="ml-5 text-white">
                        <h4>Email</h4>
                        <a href="mailto:natale.scalzo.services@gmail.com">
                          <p>natale.scalzo.services@gmail.com</p>
                        </a>
                      </div>
                    ...
                    <div class="flex mb-10 items-center">
                      ...
                      <div class="ml-5 text-white">
                        <h4>LinkedIn</h4>
                        <p><a href="https://www.linkedin.com/in/natale-scalzo-491402214/" target="_blank" class="text-white">https://www.linkedin.com/in/natale-scalzo-491402214/</a></p>
                      </div>
                    </div>
                </div>
            </div>
