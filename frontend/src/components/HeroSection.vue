                ...
                <div class="lg:py-6">
                    <div class="text-center lg:text-left">
                        <h1 class="pt-4 text-white font-bold text-4xl md:text-5xl lg:text-6xl">
                            Hello, i am <br><span class="text-transparent bg-clip-text bg-gradient-to-r from-primary to-pink-500">
                                Natale Scalzo
                            </span>😁
                        </h1>
                    </div>
                    <p class="text-gray-300 pt-8 text-center lg:text-left mx-auto max-w-xl">
                      I am a software developer with experience in designing and developing scalable, high-performance applications. I enjoy working across different technologies and architectures to build efficient and maintainable solutions.

                      I have a strong background in both backend and frontend development and am passionate about clean code, best practices, and DevOps. I strive to create robust, secure, and well-documented software while continuously improving development processes.
