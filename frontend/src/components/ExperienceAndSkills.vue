...
const Skills =ref([
    {
        id:1,
        name:'BACKEND (JAVA, GO, KOTLIN)',
        width:'98%'
    },
    {
        id:2,
        name:'FRONTEND (HTML, JAVASCRIPT, CSS, VUE, ANGULAR)',
        width:'88%'
    },
    {
        id: 3,
        name: 'DATABASE MANAGEMENT (SQL, NoSQL, PostgreSQL, MongoDB)',
        width: '90%'
    },
    {
        id: 4,
        name: 'DEVOPS & CLOUD (DOCKER, KUBERNETES, AWS, CI/CD)',
        width: '85%'
    }
]);
